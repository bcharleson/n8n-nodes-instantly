...
export const accountParameters: INodeProperties[] = [
	...
	// Email Account Selector (for non-warmup operations)
	{
		...
		displayOptions: {
			show: {
				resource: ['account'],
				operation: ['get', 'pause', 'resume', 'update', 'deleteAccount'],
			},
		},
		description: 'The email account to operate on. Choose from the list, or specify an email address.',
	},

	// WARMUP OPERATIONS - Enhanced parameters for Enable/Disable Warmup
	{
		displayName: 'Apply to All Emails',
		name: 'allEmails',
		type: 'boolean',
		default: false,
		displayOptions: {
			show: {
				resource: ['account'],
				operation: ['enableWarmup', 'disableWarmup'],
			},
		},
		description: 'Enable/disable warmup for all email accounts in your workspace',
	},
	{
		displayName: 'Email Account',
		name: 'emailAccount',
	...
	},
	{
		...
		description: 'Email accounts to exclude from the bulk warmup operation',
	},
