...
export type ResourceType = 'account' | 'campaign' | 'lead' | 'analytics' | 'superSearchEnrichment';
export type OperationType = 'addToCampaign' | 'create' | 'get' | 'getMany' | 'update' | 'delete' | 'pause' | 'resume' | 'getCampaignAnalytics' | 'updateInterestStatus' | 'launch' | 'deleteAccount' | 'enableWarmup' | 'disableWarmup' | 'run' | 'addToResource' | 'runAiEnrichment' | 'getJobStatus' | 'getHistory';
